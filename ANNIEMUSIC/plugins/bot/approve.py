...
TEXT = environ.get("APPROVED_WELCOME_TEXT", "**❅─────✧❅✦❅✧─────❅**\n**🥀ʜᴇʏ {mention}**\n\n**🏓Pᴏᴘ ᴛʜᴇ ᴄʜᴀᴍᴘᴀɢɴᴇ!🍾 A ɴᴇᴡ sᴛᴀʀ ʜᴀs Jᴏɪɴᴇᴅ ᴏᴜʀ ɢᴀʟᴀxʏ✨**\n\n**➻** {title}\n\n**💞ʟᴇᴛ's ᴄʀᴇᴀᴛᴇ ᴀ ᴠɪʙʀᴀɴᴛ ᴄᴏᴍᴍᴜɴɪᴛʏ ᴛᴏɢᴇᴛʜᴇʀ🥳**\n**❅─────✧❅✦❅✧─────❅**")
                ...
                [
                    [
                        InlineKeyboardButton(
                            " ๏ sɴᴀᴛᴄʜ ᴍᴇ ʙᴀʙʏ ๏ ", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")
                    ]
                ]
            ),
    )
