...
@app.on_message(filters.command("filter", prefixes=["/", ".", "!"]) & admin_filter)
@user_admin
...
@app.on_message(filters.command('stopall', prefixes=["/", ".", "!"]) & admin_filter)
...
@app.on_message(filters.command('stopfilter', prefixes=["/", ".", "!"]) & admin_filter)
@user_admin
